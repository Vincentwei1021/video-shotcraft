...
// 推出 10f 向右（相机追着出方向滑出前景）；暗场 6f（保留微渐变尘点让
// "still moving" 可感，不纯黑死场）；B 景 = wbr-full 周报页从 scale ~0.6 + blur
// 起步、10f 放大收焦入场。出与入同向（向右推出 → B 景从右迎来），速度曲线连续。
// 节拍：0–26 A hold → 26–36 推出（前景右移出画）→ 36–42 暗场 → 42–52 B 放大入场
// → 52–120 B hold（真静止）。
